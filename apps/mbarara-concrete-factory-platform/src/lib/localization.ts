...
export const languageCopy: Record<DisplayLanguageCode, { languageCurrency: string; baseAccounting: string; fxWarning: string; deliveryBanner: string; nav: Record<string, string> }> = {
  ...
  de: { languageCurrency: "Sprache und Waehrung", baseAccounting: "Die Basisrechnung bleibt UGX", fxWarning: "Umgerechnete Werte sind Schaetzungen und keine Bankkurse.", deliveryBanner: "KOSTENLOSE BAUSTELLENLIEFERUNG | Flottentransport direkt zur Baustelle in der Region Mbarara.", nav: { website: "Oeffentliche Website", dashboard: "Uebersicht", financials: "Finanzen", inventory: "Lager", production: "Produktion", quality: "QS Labor", erp: "ERP", market: "Marktinfo", database: "PostgreSQL", software: "Software-Kern", report: "Master PDF" } },
  zh: { languageCurrency: "语言和显示货币", baseAccounting: "基础账目仍以 UGX 记录", fxWarning: "换算金额仅用于理解，不是银行报价。", deliveryBanner: "免费工地配送 | 符合条件的大宗订单可在 Mbarara 区域内享受车队直达工地运输。", nav: { website: "公共网站", dashboard: "仪表盘", financials: "财务", inventory: "库存", production: "生产", quality: "质检实验室", erp: "ERP", market: "市场情报", database: "PostgreSQL", software: "软件核心", report: "主报告 PDF" } },
  hi: { languageCurrency: "भाषा और मुद्रा", baseAccounting: "मुख्य लेखा UGX में रहेगा", fxWarning: "बदले हुए मूल्य केवल समझने के लिए अनुमान हैं, बैंक दरें नहीं।", deliveryBanner: "मुफ्त साइट डिलीवरी | योग्य bulk orders के लिए Mbarara क्षेत्र में सीधे निर्माण स्थल तक परिवहन।", nav: { website: "सार्वजनिक वेबसाइट", dashboard: "डैशबोर्ड", financials: "वित्त", inventory: "इन्वेंटरी", production: "उत्पादन", quality: "QC लैब", erp: "ERP", market: "मार्केट इंटेल", database: "PostgreSQL", software: "सॉफ्टवेयर कोर", report: "मास्टर PDF" } },
  fr: { languageCurrency: "Langue et devise", baseAccounting: "La comptabilite de base reste en UGX", fxWarning: "Les montants convertis sont des estimations, pas des taux bancaires.", deliveryBanner: "LIVRAISON GRATUITE SUR CHANTIER | Transport direct vers votre chantier dans la region de Mbarara.", nav: { website: "Site public", dashboard: "Tableau de bord", financials: "Finances", inventory: "Stock", production: "Production", quality: "Labo QC", erp: "ERP", market: "Marche", database: "PostgreSQL", software: "Noyau logiciel", report: "PDF maitre" } },
  sw: { languageCurrency: "Lugha na sarafu", baseAccounting: "Hesabu kuu bado ni UGX", fxWarning: "Thamani zilizobadilishwa ni makadirio, si bei rasmi za benki.", deliveryBanner: "USAFIRISHAJI WA BURE | Usafirishaji moja kwa moja kwenye eneo la ujenzi mkoa wa Mbarara.", nav: { website: "Tovuti ya Umma", dashboard: "Dashibodi", financials: "Fedha", inventory: "Stoo", production: "Uzalishaji", quality: "Maabara QC", erp: "ERP", market: "Soko", database: "PostgreSQL", software: "Msingi wa programu", report: "PDF Kuu" } },
  ar: { languageCurrency: "اللغة وعملة العرض", baseAccounting: "تبقى الحسابات الأساسية بعملة UGX", fxWarning: "القيم المحولة تقديرية للفهم وليست أسعار بنك.", deliveryBanner: "توصيل مجاني للموقع | نقل مباشر إلى موقع البناء داخل منطقة مبارارا للطلبات الكبيرة المؤهلة.", nav: { website: "الموقع العام", dashboard: "لوحة التحكم", financials: "المالية", inventory: "المخزون", production: "الإنتاج", quality: "مختبر الجودة", erp: "ERP", market: "معلومات السوق", database: "PostgreSQL", software: "نواة البرمجيات", report: "تقرير PDF" } },
  es: { languageCurrency: "Idioma y moneda", baseAccounting: "La contabilidad base sigue en UGX", fxWarning: "Los valores convertidos son estimaciones, no cotizaciones bancarias.", deliveryBanner: "ENTREGA GRATUITA EN OBRA | Transporte directo a su obra en la region de Mbarara.", nav: { website: "Sitio publico", dashboard: "Panel", financials: "Finanzas", inventory: "Inventario", production: "Produccion", quality: "Lab QC", erp: "ERP", market: "Mercado", database: "PostgreSQL", software: "Nucleo software", report: "PDF maestro" } },
};
