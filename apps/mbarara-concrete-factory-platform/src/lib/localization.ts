...
export const languageCopy: Record<DisplayLanguageCode, { languageCurrency: string; baseAccounting: string; fxWarning: string; deliveryBanner: string; nav: Record<string, string> }> = {
  ...
  zh: { languageCurrency: "语言和显示货币", baseAccounting: "基础账目仍以 UGX 记录", fxWarning: "换算金额仅用于理解，不是银行报价。", deliveryBanner: "免费工地配送 | 符合条件的大宗订单可在 Mbarara 区域内享受车队直达工地运输。", nav: { website: "公共网站", dashboard: "仪表盘", financials: "财务", inventory: "库存", production: "生产", quality: "质检实验室", erp: "ERP", market: "市场情报", database: "PostgreSQL", report: "主报告 PDF" } },
  hi: { languageCurrency: "भाषा और मुद्रा", baseAccounting: "मुख्य लेखा UGX में रहेगा", fxWarning: "बदले हुए मूल्य केवल समझने के लिए अनुमान हैं, बैंक दरें नहीं।", deliveryBanner: "मुफ्त साइट डिलीवरी | योग्य bulk orders के लिए Mbarara क्षेत्र में सीधे निर्माण स्थल तक परिवहन।", nav: { website: "सार्वजनिक वेबसाइट", dashboard: "डैशबोर्ड", financials: "वित्त", inventory: "इन्वेंटरी", production: "उत्पादन", quality: "QC लैब", erp: "ERP", market: "मार्केट इंटेल", database: "PostgreSQL", report: "मास्टर PDF" } },
  ...
  ar: { languageCurrency: "اللغة وعملة العرض", baseAccounting: "تبقى الحسابات الأساسية بعملة UGX", fxWarning: "القيم المحولة تقديرية للفهم وليست أسعار بنك.", deliveryBanner: "توصيل مجاني للموقع | نقل مباشر إلى موقع البناء داخل منطقة مبارارا للطلبات الكبيرة المؤهلة.", nav: { website: "الموقع العام", dashboard: "لوحة التحكم", financials: "المالية", inventory: "المخزون", production: "الإنتاج", quality: "مختبر الجودة", erp: "ERP", market: "معلومات السوق", database: "PostgreSQL", report: "تقرير PDF" } },
